module constants
  ...
  integer, parameter :: seedfac = 12

  integer, parameter :: nLat     = 2048
  integer, parameter :: nTimeMax = 2*nLat
  integer, parameter :: lSim = 0, nSim = 100

  real(dl), parameter :: phi0   = twopi / 3.2_dl
